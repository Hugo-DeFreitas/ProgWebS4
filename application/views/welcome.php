...
<html lang="fr">
    ...
    <div id="landing-message-vegas" class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center">
        <div class="col-md-5 p-lg-5 mx-auto my-5 text-light">
            ...
            <a class="btn btn-outline-secondary" href="#about">En savoir plus</a>
        </div>
    </div>
                ...
                $.ajax( {
                    ...
                    .done(function(response) {
                        ...
                        if(responseObject.success){
                            callBackDiv.html("<div class=\"alert alert-success\" role=\"alert\">" +
                                "Connexion réussie <i class='fa fa-success'></i>"+
                                "</div>");
                            setTimeout(function () {
                            ...
                            callBackDiv.html("<div class=\"alert alert-danger\" role=\"alert\">" +
