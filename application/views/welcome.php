...
<footer class="container py-5">
    ...
    <script>
        $("#landing-message-vegas").vegas({
            ...
            slides: [
                { src: '<?php echo base_url('assets/images/slide-1.png')?>'},
                { src: '<?php echo base_url('assets/images/slide-2.png')?>'},
                { src: '<?php echo base_url('assets/images/slide-3.png')?>'},
            ],
            overlay: '<?php echo base_url('assets/js/vegas/overlays/03.png')?>'
        });
